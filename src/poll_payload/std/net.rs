...
impl<C: Send + Sync> AsyncPayload<C> for Ipv4Addr {}
...
impl<C: Send + Sync> AsyncPayload<C> for Ipv6Addr {}
...
impl<C: Send + Sync> AsyncPayload<C> for IpAddr {}
...
impl<C: Send + Sync> AsyncPayload<C> for SocketAddr {}
